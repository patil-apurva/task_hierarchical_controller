...
agents_dist_PI_bulk = []; %distance between 2 agents bulk
dist_from_goal_PI_bulk = []; %distance between centroid of two agents and goal bulk
...
agents_dist_PI_mean = mean(agents_dist_PI, 1);
agents_dist_PI_std = std(agents_dist_PI, 1);

save("for_plotting_PI.mat", "agents_dist_PI_mean", "agents_dist_PI_std", "dist_from_goal_PI_mean", "dist_from_goal_PI_std", "desired_dist_bet_agents")