function S_tau_all = simulateMC_unicycle_2agents_drift(eps_t_all_1, eps_t_all_2, eps_t_all_3, eps_t_all_4, ...
    ...
    N3_11, N3_12, N3_13, N3_14, N3_21, N3_22, N3_23, N3_24, N3_31, N3_32, N3_33, N3_34, N3_41, N3_42, N3_43, N3_44, k1, k2, k3, y1_0, y2_0)   
...
%                  + h*e*0.5*(sqrt((x1_t_prime - x2_t_prime)^2 + (y1_t_prime - y2_t_prime)^2) - ell)^2;
        ...
        x1_t_prime = x1_t_prime + k1*x1_t_prime*h + v1_t_prime*cos(theta_1_t_prime)*h;
        y1_t_prime = y1_t_prime + k1*(y1_t_prime)*h + v1_t_prime*sin(theta_1_t_prime)*h;
        x2_t_prime = x2_t_prime + k1*x2_t_prime*h + v2_t_prime*cos(theta_2_t_prime)*h;
        y2_t_prime = y2_t_prime + k1*(y2_t_prime)*h + v2_t_prime*sin(theta_2_t_prime)*h;
        ...
        %move the trajectory forward
        v1_t_prime = v1_t_prime + k2*v1_t_prime*h + a1_1_t_prime*h + N2N3_11*a3_1_t_prime*h + N2N3_12*omega3_1_t_prime*h + N2N3_13*a3_2_t_prime*h + N2N3_14*omega3_2_t_prime*h ...
                    + s*sqrt(h)*(N2_11*eps_t_prime_1 + N2_12*eps_t_prime_2 + N2_13*eps_t_prime_3 + N2_14*eps_t_prime_4); %move tau ahead
                
        theta_1_t_prime = theta_1_t_prime + k3*theta_1_t_prime*h + omega1_1_t_prime*h + N2N3_21*a3_1_t_prime*h + N2N3_22*omega3_1_t_prime*h + N2N3_23*a3_2_t_prime*h + N2N3_24*omega3_2_t_prime*h ...
                         + s*sqrt(h)*(N2_21*eps_t_prime_1 + N2_22*eps_t_prime_2 + N2_23*eps_t_prime_3 + N2_24*eps_t_prime_4); %move tau ahead
                    
        v2_t_prime = v2_t_prime + k2*v2_t_prime*h + a1_2_t_prime*h + N2N3_31*a3_1_t_prime*h + N2N3_32*omega3_1_t_prime*h + N2N3_33*a3_2_t_prime*h + N2N3_34*omega3_2_t_prime*h ...
                    + s*sqrt(h)*(N2_31*eps_t_prime_1 + N2_32*eps_t_prime_2 + N2_33*eps_t_prime_3 + N2_34*eps_t_prime_4); %move tau ahead
                
        theta_2_t_prime = theta_2_t_prime + k3*theta_2_t_prime*h + omega1_2_t_prime*h + N2N3_41*a3_1_t_prime*h + N2N3_42*omega3_1_t_prime*h + N2N3_43*a3_2_t_prime*h + N2N3_44*omega3_2_t_prime*h ...
